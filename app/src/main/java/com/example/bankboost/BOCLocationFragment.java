...
public class BOCLocationFragment extends Fragment implements OnMapReadyCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_boc_location, container, false);

        setHasOptionsMenu(true);

        SupportMapFragment mapFragment = (SupportMapFragment) getChildFragmentManager()
                .findFragmentById(R.id.bocMap);
        mapFragment.getMapAsync(this);

        // Setting the on click listener for the compass icon
        ...
        // Setting the on click listener for the bank icon
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (ActivityCompat.checkSelfPermission(getContext(),
            ...
            // Requesting location permissions if not granted by the user
        ...
        DatabaseReference bocRef = database.getReference("banks/BOC");

        bocRef.addValueEventListener(new ValueEventListener() {
            @Override
    ...
    // Finding the nearest marker o bank branch to the user's current location
